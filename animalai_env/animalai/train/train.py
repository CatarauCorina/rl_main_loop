...
def run_training(run_seed: int, options: RunOptions, animalai_options: AAIOptions) -> None:
    """
...
def create_environment_factory(
    ...
    def create_unity_environment(
        ...
        return AnimalAIEnvironment(
            ...
            raysPerSide=animalai_options.raysPerSide,
            rayMaxDegrees=animalai_options.rayMaxDegrees,
        )
    return create_unity_environment


def run_cli(options: RunOptions, animalai_options: AAIOptions) -> None:
    try:
        print(
            """
    ...
    run_training(run_seed, options, animalai_options)


def main(animalai_options: str):
    run_cli(parse_command_line(), animalai_options)
